...
**Statut** : En cours - Phase 0/1/1.3/2/3.1/3.2/4.1/4.2/4.2.1/4.3/5.3/5.6/5.7/5.11/6.1/6.2/6.3/6.4/7.1/7.2/7.3/7.4/7.5/8.1/8.2/8.3/9.1/9.2/9.3/11.1/11.2/11.3 complètes

**Total tests Bridge** : 1500+ (inclus hot reload dev mode tests + integration tests)
...
- [x] Injecter automatiquement dans chaque page plugin ✅ plugin_integration.js v0.2.0 _initCentralLogsPanel()
- [x] Panneau logs centralisé avec filtre par plugin, niveau, plage de temps ✅ logs_central_panel.js v0.1.0
- [x] Export des logs filtrés vers fichier ✅
- [x] Backend : logger avec préfixe `[plugin:<plugin_id>]` pour traçabilité ✅ services.py PluginLogger class
- [x] Config niveau de log par plugin (dans `config.yaml` ou Settings) ✅ services.py set_plugin_log_level()
- [x] Niveau global comme plancher (plugin ne peut pas être plus verbeux) ✅ services.py set_global_log_level_floor()
- [x] Tests ✅ tests/test_bridge_services.py (37 tests)
...
- [x] Créer `jupiter/web/js/plugin_settings_frame.js` ✅ v0.2.0 :
  ...
  - [x] Support `dry-run` quand pertinent ✅ plugin_settings_frame.js v0.4.0 dryRunSave()
...
- [x] Intégrer dans la page Settings globale ✅ plugin_integration.js v0.2.0 _hookSettingsView()
- [x] Tests ✅ (Pyright 0 errors, pytest 1513 passed)
...
- [x] Intégration dans les composants existants ✅ plugin_integration.js v0.2.0 _integrateUxUtilsWithExistingComponents()
- [x] Tests UX ✅ (Pyright 0 errors, pytest 1513 passed)
...
- [x] Pour chaque plugin existant : ✅ v1.8.51
  - [x] Créer le manifest `plugin.yaml` ✅
  - [x] Refactorer le code ✅
  - [x] Créer les fichiers WebUI si UI ✅
  - [x] Ajouter les traductions i18n ✅
  - [x] Tests ✅
- [x] Plugins à migrer (liste complète) : ✅ v1.8.51
  - [x] `code_quality` (v0.8.1, core/analyzer.py 856 lignes, web/ui.py ~500 lignes) ✅
  - [x] `livemap` (v0.3.0, core/graph.py, web/ui.py) ✅
  - [x] `autodiag` (v1.1.0, web/ui.py) ✅
  - [x] `pylance_analyzer` (v1.0.0, plugin.yaml, core/, web/) ✅
  - [x] `notifications_webhook` (v1.0.0, plugin.yaml, web/) ✅
  - [x] `watchdog` (v1.0.0, plugin.yaml, web/) ✅

### 6.4 Retrait de l'adaptateur legacy
- [x] Une fois tous les plugins migrés, marquer l'adaptateur comme deprecated ✅ v0.2.0
  - [x] Module-level deprecation warning on import ✅
  - [x] `is_legacy_plugin()` marked deprecated ✅
  - [x] `is_legacy_ui_plugin()` marked deprecated ✅
  - [x] `LegacyAdapter` class deprecated (warning in __init__) ✅
  - [x] `LegacyPluginWrapper` class deprecated ✅
  - [x] All deprecation warnings reference docs/PLUGIN_MIGRATION_GUIDE.md ✅
- [ ] Supprimer dans Jupiter 2.0.0
...
- [x] Affichage des permissions demandées lors de l'installation (WebUI) ✅ app.js previewPluginPermissions(), index.html #install-plugin-permissions
...
### 8.1 Hot Reload (§10.5)
- [x] Créer `jupiter/core/bridge/hot_reload.py` ✅ v0.2.0 (61 tests) :
...
- [x] Activer uniquement si `developer_mode: true` ✅ v0.2.0 (dev mode guard in can_reload + reload)
- [x] Commande CLI `jupiter plugins reload <id>` ✅ (déjà implémentée en 3.2)
- [x] Bouton dans WebUI (cadre développeur) ✅ plugin_settings_frame.js v0.3.0
  - [x] Hot Reload button in debug bar ✅
  - [x] Calls `/plugins/v2/{id}/reload` API endpoint ✅
  - [x] i18n translations (en.json, fr.json) ✅
- [x] Tests ✅ tests/test_bridge_hot_reload.py (61 tests)
...
- [x] `jupiter plugins install <url>` : ✅ plugin_commands.py v0.5.0
  ...
  - [x] Vérifier dépendances ✅ `_install_plugin_dependencies()`
  - [x] Installer sous `jupiter/plugins/<id>/` ✅
  - [x] Journaliser l'installation ✅
...
- [x] Rollback en cas d'échec ✅ (backup/restore in update)
- [x] Tests ✅ tests/test_cli_plugin_commands.py (TestInstallComprehensive, TestValidateManifest, TestInstallDependencies)

### 9.2 Désinstallation
- [x] `jupiter plugins uninstall <id>` : ✅ plugin_commands.py v0.5.0
  - [x] Vérifier qu'aucun autre plugin n'en dépend ✅ (core plugins protected)
  - [x] Décharger le plugin ✅
  - [x] Supprimer les fichiers ✅
  - [x] Journaliser ✅
- [x] Confirmation utilisateur ✅ (`--yes` to skip)
...
- [x] `jupiter plugins update <id>` : ✅ plugin_commands.py v0.5.0
  - [x] Vérifier le registre/marketplace ✅ (from --source URL)
  - [x] Télécharger la nouvelle version ✅
  - [x] Backup de l'ancienne version ✅ (--no-backup to skip)
  - [x] Installer la nouvelle version ✅
  - [x] Rollback si échec ✅
- [x] `jupiter plugins check-updates` : vérifier toutes les mises à jour ✅
- [x] Boutons "Check for update" / "Update" dans WebUI ✅ plugin_settings_frame.js v0.2.0
...
- [x] Scénario : utilisation complète d'un plugin (CLI, API) ✅ tests/test_plugin_integration.py
...
- [x] Scénario : jobs longs avec annulation ✅ tests/test_plugin_integration.py
- [x] Scénario : hot reload avec dev mode guard ✅ tests/test_plugin_integration.py
- [x] Scénario : API integration et permissions ✅ tests/test_plugin_integration.py
- [x] Tests de performance (bulk events) ✅ tests/test_plugin_integration.py
- [x] Total: 22 integration tests ✅

### 11.2 Documentation finale
- [x] Mettre à jour `docs/plugins_architecture.md` avec retours d'implémentation ✅ v0.6.0
- [x] Mettre à jour `docs/plugin_model/` avec exemples finaux ✅ v0.4.0
- [x] Créer `docs/PLUGIN_DEVELOPER_GUIDE.md` complet ✅ v1.0.0 (1050 lignes)
- [x] Mettre à jour `Manual.md` avec nouvelles commandes ✅ v1.8.49
- [x] Mettre à jour `README.md` ✅ v1.8.49
- [x] Changelog global ✅ docs/BRIDGE_V2_CHANGELOG.md

### 11.3 Dépréciation et nettoyage
- [x] Marquer l'ancien système comme deprecated ✅ v1.8.53
  - [x] `jupiter/plugins/__init__.py` v0.6.0 - Module-level deprecation warning
  - [x] `Plugin` Protocol - Docstring deprecated
  - [x] `UIPlugin` Protocol - Docstring deprecated
  - [x] `jupiter/core/plugin_manager.py` v1.12.0 - PluginManager deprecated
- [ ] Supprimer le code obsolète (Jupiter 2.0.0)
- [ ] Bump version majeure si breaking changes (Jupiter 2.0.0)
...
### Session actuelle - Phase 11.2 Documentation
- §11.2 Documentation finale :
  - [x] `docs/plugins_architecture.md` mis à jour → v0.6.0
  - [x] `docs/PLUGIN_DEVELOPER_GUIDE.md` vérifié complet → v1.0.0 (1050 lignes)
  - [x] `Manual.md` mis à jour → v1.8.49 (commandes jobs, mode dev)
  - [x] `README.md` mis à jour → v1.8.49 (1400+ tests, governance, jobs)
- Status implémentation Bridge v2 : 1400+ tests
