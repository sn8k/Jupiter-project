...
- Persist the active project root back to the shared state file whenever a project is activated so subsequent CLI/GUI launches reopen the correct project.
